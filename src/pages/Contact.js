...
const Contact = () => {
  useDocTitle("CK | CODEKLUGER - Send us a message");
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_jik0oho", "template_rivzwbq", form.current, {
        publicKey: "3rl096XTDTkMsH75D",
      })
      .then(
        (response) => {
          clearInput();
          ...
          Notiflix.Report.success(
            "Success",
            "Support Email sent Will contact you very soon",
            "Okay"
          );
        },
        (error) => {
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-5">
                    ...
                    <p className="text-gray-400">codekluger@gmail.com</p>
                  </div>
                </div>
              </div>
