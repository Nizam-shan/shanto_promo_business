    ...
    <div id="services" className="bg-gray-100 py-12">
      <section data-aos="zoom-in-down">
        <div className="my-4 py-4">
          <h2 className="my-2 text-center text-3xl text-sky-800 uppercase font-bold">
            services
          </h2>
          ...
          <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-sky-800">
        ...
        <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
          ...
          >
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
              ...
              <h3
                className="text-3xl  text-sky-800 
                            font-bold"
              >
              ...
              <div>
                <p className="my-3 text-xl text-gray-600 font-semibold">
                  With over 3+ years experience in software analysis and design
